...
function TableSection() {
  const getStatusColor = (status) =>{
    switch (status) {
      ...
      default:
        return "bg-slate-100 text-gray-700 dark:bg-slate-800 dark:text-slate-400";
  }}
  return (
    <div className="space-y-6">
      ...
      {/* Top products*/}
      <div className="bg-white/-80 dark:bg-slate-900/80 backdrop-blur-xl rounded-2xl border border-slate-200/50 dark:border-slatee-700/50 overflow-hidden">
         <div className="p-6 border-b border-slate-200/50 dark:border-slate-700/50">
              <div className="flex items-center justify-between">
         ...
         <div className="p-6 space-y-4">
           {topProducts.map((product,index) =>{
              return( 
                <div className="flex items-center justify-between p-4 rounded-xl hover:bg-slate-500 dark:hover:bg-slate-800/50 transition-colors">
